...
<p>First, <code>npm link</code> in a package folder will create a symlink from
the local <code>node_modules</code> folder to the global folder <code>{prefix}/lib/node_modules/</code>
(see <code><a href="../misc/npm-config.html">npm-config(7)</a></code> for the value of <code>prefix</code>).</p>
...
<p id="footer">npm-link &mdash; npm@3.8.2</p>
