...
.P
First, \fBnpm link\fP in a package folder will create a symlink from
the local \fBnode_modules\fP folder to the global folder \fB{prefix}/lib/node_modules/\fP
(see npm help 7 \fBnpm\-config\fP for the value of \fBprefix\fP)\.
.P
